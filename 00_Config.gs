...
const CONFIG = {
  ...
  // ยืนยันจากพี่นก (2026-06-10): คืนเครื่องแล้วผ่อนต่อ = รับคืนเบ็ดเสร็จทั้งสัญญาเดิม
  // → ออก CN ปิดสัญญาเดิมเต็มยอดคงเหลือเหมือนกัน แล้วเปิดสัญญาใหม่แยกต่างหาก
  RETURN_WORKFLOW_ISSUE_CN: ['ขายส่ง Yellobe', 'ผ่อนต่อ finfin'],
